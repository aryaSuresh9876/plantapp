...
public class PlantMenuActivity extends AppCompatActivity implements MenuListAdapter.MenuListClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plantstore_menu);
        ...
        menuList = PlantStoreModel.getMenus();
        initRecyclerView();
        ...
        buttonCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(itemsInCartList != null && itemsInCartList.size() <= 0) {
                    Toast.makeText(PlantMenuActivity.this, "Please add some items in cart.", Toast.LENGTH_SHORT).show();
                    return;
                }
                PlantStoreModel.setMenus(itemsInCartList);
                Intent i = new Intent(PlantMenuActivity.this, PlaceYourOrderActivity.class);
